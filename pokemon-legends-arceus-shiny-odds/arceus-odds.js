/* ============================================================
   Pokemon Legends: Arceus - mini shiny odds calculator (locked to this game)
...
(function () {
  ...
  var BASE = 4096;
  var BOOSTS = [
    { id: "charm", label: "Shiny Charm", note: "research Lv. 10 across the dex", adds: 3, group: null },
    { id: "dex10", label: "Research Lv. 10", note: "species Pokedex research", adds: 1, group: "research" },
    { id: "perfect", label: "Perfect Research Page", note: "counts on top of Lv. 10", adds: 3, group: "research" },
    { id: "mmo", label: "Massive Mass Outbreak", note: "map-wide spawners", adds: 12, group: "outbreak" },
    { id: "mo", label: "Mass Outbreak", note: "single species, no timer", adds: 25, group: "outbreak" }
  ];

  var active = {};
  var encounters = 1000;
  var ratePerHour = 60;
  var LS_KEY = 'rpg:odds-arceus';
