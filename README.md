...
- ⚡ Zero-dependency single page: `index.html` + `styles.css` + `app.js` + `data.js`
- 🔎 SEO: semantic HTML, JSON-LD (SoftwareApplication + FAQPage), OG/Twitter meta

## Usage

Open `index.html` in a browser or serve statically. Data sourced from [PokeAPI](https://pokeapi.co/).
