/* ============================================================
   Pokemon Legends: Z-A - mini shiny odds calculator (locked to this game)
...
(function () {
  ...
  var BASE = 4096;
  var BOOSTS = [
    { id: "charm", label: "Shiny Charm", note: "complete Mable's research", adds: 3, group: null },
    { id: "sparkling1", label: "Sparkling Power Lv. 1", note: "Sparkling Power donut", adds: 1, group: "sparkling" },
    { id: "sparkling2", label: "Sparkling Power Lv. 2", note: "Sparkling Power donut", adds: 2, group: "sparkling" },
    { id: "sparkling3", label: "Sparkling Power Lv. 3", note: "Sparkling Power donut", adds: 3, group: "sparkling" }
  ];

  var active = {};
  var encounters = 1000;
  var ratePerHour = 60;
  var LS_KEY = 'rpg:odds-za';
