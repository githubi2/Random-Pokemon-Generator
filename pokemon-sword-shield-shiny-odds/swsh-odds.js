/* ============================================================
   Pokemon Sword & Shield - mini shiny odds calculator (locked to this game)
...
(function () {
  ...
  var BASE = 4096;
  var BOOSTS = [
    { id: "charm", label: "Shiny Charm", note: "complete the Galar Pokedex", adds: 2, group: null },
    { id: "brilliant100", label: "Brilliant Spawn (100 KOs)", note: "species KO count", adds: 3, group: "brilliant" },
    { id: "brilliant200", label: "Brilliant Spawn (200 KOs)", note: "species KO count", adds: 4, group: "brilliant" },
    { id: "brilliant300", label: "Brilliant Spawn (300 KOs)", note: "species KO count", adds: 5, group: "brilliant" },
    { id: "brilliant500", label: "Brilliant Spawn (500 KOs)", note: "species KO count", adds: 6, group: "brilliant" }
  ];

  var active = {};
  var encounters = 1000;
  var ratePerHour = 60;
  var LS_KEY = 'rpg:odds-swsh';
